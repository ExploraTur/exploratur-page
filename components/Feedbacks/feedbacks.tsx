...
export const Feedbacks = () => {
  return (
    <section className="text-center w-full py-20 bg-gradient-to-t from-main to-main-dark ">
      <h3 className="font-bold mx-2 text-2xl sm:text-4xl text-submain">
        O que dizem nossos exploradores?
      </h3>
      <p className="text-gray-300 text-sm sm:mt-4 mt-2">Média de classificação dos clientes</p>
      <Ratings />
      <Carousel>
