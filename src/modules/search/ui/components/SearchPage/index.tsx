...
// TODO: Search into database and display cards
...
export const SearchPage = ({}: SearchProps) => {
  return (
    <section className="border-y py-12 my-10 mx-auto max-w-7xl px-2 flex-wrap flex justify-center gap-x-5 gap-4 sm:gap-y-12">
      <div className="relative">
        <Button
          size="icon"
          variant="ghost"
          className="absolute z-10 top-4 right-4 bg-white text-main-dark hover:text-red-500 transition"
        >
          <Heart size={24} />
        </Button>
        ...
        <div className="flex justify-center">
          <div className="-mt-3 z-10 relative bg-white p-4 shadow-lg shadow-main-dark/40 rounded-xl max-w-[340px]">
            <div className="flex justify-between">
              <p className="font-bold text-main-dark text-lg">
                Pico do Arieiro
              </p>
              <div className="flex gap-1 items-center">
                <Image
                  src="/rate.png"
                  alt="Classificação dos usuários"
                  width={60}
                  height={12}
                />
            ...
            <p className="text-gray-600 py-2">
              Conheça as belas montanhas e faça uma trilha de 3km até seu pico.
            </p>
